...
function wpb_comment_count() {
  ...
  if($comments_count < 2) {
    $message =  'Il y a <strong>'.  $comments_count->approved . '</strong> commentaire posté pour cet article.';
  }
  else {
    $message =  'Il y a <strong>'.  $comments_count->approved . '</strong> commentaires postés pour cet article.';
  }
  return $message;
}
